...
* Вывести данные о клиентах у которых рейтинг больше 4,5.
3. Аналитические:
...
* Высчитать процент клиентов с определённым рейтингом.

# Список сущностей БД "Автомобили":
1. Автомобили:
* id — int
* Год выпуска — int
* Остаток топлива — int
...
# Список сущностей БД "Клиенты":
1. Клиенты:
* id — int
* Имя — char
* Фамилия — char
* Отчество — char
* Дата получения паспорта — date
* Номер водителского удостоверения — char
* Рейтинг — int
...
5. Заказы:
* id — int
* Время начала аренды — date
* Время конца аренды — date
6. Тарифы:
* id — int
* Название — char
* Цена — int
